...
export function Sidebar() {
  ...
  return (
    <div
      className={cn(
        'relative z-50 flex h-full flex-shrink-0 flex-col border-r border-gray-200 bg-white transition-all duration-300 dark:border-neutral-800 dark:bg-neutral-950',
